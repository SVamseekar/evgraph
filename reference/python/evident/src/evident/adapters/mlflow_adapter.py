...
ADAPTER_NAME = "evident-adapter-mlflow"
...
class MLflowAdapter:
    ...
    def scan(self, client: Any, source: MLflowModelSource) -> EvidenceGraph:
        ...
        `get_run` methods) — not imported as a hard evident dependency, since
        `mlflow` is a development/validation dependency of this repo, not a
        runtime dependency of the `evident` package (docs/ROADMAP.md Stage 4.5
        Goal 2).
        """
