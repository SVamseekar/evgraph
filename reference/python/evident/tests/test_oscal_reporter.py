...
from evident_core import EvidenceEdge, EvidenceGraph, EvidenceLevel, EvidenceNode, Finding, Outcome

from evident.reporters.oscal_reporter import to_oscal_assessment_results_dict
...
def test_evidence_level_carried_as_prop_extension_on_observation():
    ...
    for obs in observations:
        ...
        assert level_props[0]["ns"] == "https://github.com/evident-org/evident/ns/oscal"
