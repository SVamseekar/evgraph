...
from evgraph_core.evidence_level import EvidenceLevel
from evgraph_core.graph import EvidenceEdge
...
class Finding:
    ...
    `level` must be constructed via `evgraph_core.compute_finding_level` (RES §4.3) —
